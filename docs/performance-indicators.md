...
| Percentual de horários mais requisitados | Analisar os horários mais requisitados pelo público | Quantificar o percentual de consultas em uma determinada hora, em relação ao total de consultas  | Tabela Disponibilidade de Horário | Processos Internos |
